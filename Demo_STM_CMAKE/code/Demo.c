...
void displayExercise2()
{
	...
	const uint16_t circleLineWidth = 5;
	const uint16_t circlePositionX = 50 ; // Left X Axis
	const uint16_t circlePositionY = (float)1/3 * displaySizeY; // 1/3 Top Y Axis

	const uint16_t triangleLength = 20;
	const uint16_t trianglePositionX = 2/3 * displaySizeX; // Middle X Axis
	const uint16_t trianglePositionY = displaySizeY;

	const uint16_t trianglePointA_X =  displaySizeX/2 -20;
	const uint16_t trianglePointA_Y = (float)1/3 * displaySizeY + 50;
	const uint16_t trianglePointB_X = displaySizeX/2 + 30;
	const uint16_t trianglePointB_Y = (float)1/3 * displaySizeY + 40;
	const uint16_t trianglePointC_X = displaySizeX/2;
	const uint16_t trianglePointC_Y = (float)1/3 * displaySizeY - circleRadius - 10;

	const uint16_t squareLength = 50;
	const uint16_t squarePositionX = displaySizeX - 80 ; // Right X Axis
	const uint16_t squarePositionY = (float)1/3 * displaySizeY - circleRadius;
